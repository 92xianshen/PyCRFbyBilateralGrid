...
# bilateral_filter.compute(inp_up, result)
# bilateral_filter.compute(all_ones, weight)
...
spatial_filter.compute(inp_up, result)
spatial_filter.compute(all_ones, weight)
